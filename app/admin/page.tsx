      ...
      <div className="bg-white rounded-xl w-full max-w-md mx-auto p-6">
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3">
          ...
          <button
            ...
            className="w-full sm:w-auto px-4 py-3 sm:py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition disabled:opacity-50 flex items-center justify-center gap-2"
          >
            Open WhatsApp
          </button>
        </div>
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3">
          ...
          {order.status !== 'dispatched' ? (
            ...
            <button
              onClick={onClose}
              disabled={isUpdating}
              className="w-full sm:w-auto px-4 py-3 sm:py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition disabled:opacity-50"
            >
              Done
            </button>
          )}
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-3 sm:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              required
            />
          </div>
          <div>
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4">
            <button
              type="submit"
              disabled={isSaving}
              className="w-full sm:flex-1 flex items-center justify-center gap-2 px-4 py-3 sm:py-2 bg-green-700 text-white rounded-lg hover:bg-green-800 transition disabled:opacity-50"
            >
              {isSaving ? (
                <>
...
export default function AdminPage() {
  ...
  const ADMIN_EMAILS = ['mr.onyanchaandrew@gmail.com', 'pemafreshgroceries@gmail.com'];
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center gap-2 px-4 py-3 sm:py-2 bg-green-700 text-white rounded-lg hover:bg-green-800 transition disabled:opacity-50 w-full sm:w-auto"
              >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="pl-10 pr-4 py-3 sm:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent w-full"
                    />
                  </div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="appearance-none px-4 py-3 sm:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent pr-10 w-full"
                    >
                        ...
                        <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                          ...
                          {order.status === 'delivered' ? (
                            ...
                            <button
                              ...
                              className="text-xs bg-green-600 text-white px-2 py-1.5 rounded hover:bg-green-700 transition disabled:opacity-50"
                            >
                              Mark Paid
                            </button>
                            ...
                            <div className="flex flex-col gap-1">
                              <button
                                ...
                                className="text-xs bg-green-600 text-white px-2 py-1.5 rounded hover:bg-green-700 transition text-center"
                              >
                                WhatsApp
                              </button>
                              <button
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-3 sm:py-2 bg-green-700 text-white rounded-lg hover:bg-green-800 transition w-full sm:w-auto"
                  >
                    <Plus size={18} />
                    Add Product
                  </button>
            ...
            <form onSubmit={handleAddProduct} className="p-4 sm:p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                  required
                />
                {imageSizeWarning && (
